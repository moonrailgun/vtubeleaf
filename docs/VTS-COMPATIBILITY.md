...
Gesture deactivation and animation release/timer options still skip the whole hotkey. Gesture, Twitch and on-screen triggers are reported as unsupported. Custom fade durations are reported and use the existing runtime fade.
